...
const ERROR_MESSAGES = {
  google_not_configured: {
    ...
    steps: [
      ...
      'Redirect URI: https://codeduel-zxd9.onrender.com/api/auth/google/callback',
  ...
  github_not_configured: {
    ...
    steps: [
      ...
      'Click "New OAuth App"',
      'Homepage URL: https://codeduel-zxd9.onrender.com',
      'Callback URL: https://codeduel-zxd9.onrender.com/api/auth/github/callback',
      'Copy Client ID & Secret → add to your .env file',
    ],
